...
onready var label_hotspot = get_node("ui/Label_hotspot")
...
func _on_schoolbag_mouse_enter():
	...
	hover_node = get_node("ui/schoolbag")
...
func _on_calendar_mouse_enter():
	...
	hover_node = get_node("ui/calendar")
